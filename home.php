...
<section class="category">
   ...
   <a href="category.php?category=Tshirt" class="swiper-slide slide">
      <img src="images/outfit3.png" alt="">
      <h3>Tshirt</h3>
   </a>

   <a href="category.php?category=Coat" class="swiper-slide slide">
      <img src="images/coat.jpeg" alt="">
      <h3>Coat</h3>
   </a>

   <a href="category.php?category=Cardigan" class="swiper-slide slide">
      <img src="images/cardigan.jpeg" alt="">
      <h3>Cardigan</h3>
   </a>

   <a href="category.php?category=Pants" class="swiper-slide slide">
      <img src="images/bottoms.jpeg" alt="">
      <h3>Pants</h3>
   </a>
